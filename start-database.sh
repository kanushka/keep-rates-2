...
DB_PASSWORD=$(echo "$STORAGE_DATABASE_URL" | awk -F':' '{print $3}' | awk -F'@' '{print $1}')
DB_PORT=$(echo "$STORAGE_DATABASE_URL" | awk -F':' '{print $4}' | awk -F'\/' '{print $1}')
DB_NAME=$(echo "$STORAGE_DATABASE_URL" | awk -F'/' '{print $4}')
